...
assert.equal(FREE_SVG_MODEL, 'claude-sonnet-4-6');
assert.equal(PREMIUM_SVG_MODEL, 'claude-opus-4-7');
assert.equal(getSvgGenerationModel('FREE'), 'claude-sonnet-4-6');
assert.equal(getSvgGenerationModel('PREMIUM'), 'claude-opus-4-7');
assert.equal(getSvgGenerationModel('HM'), 'claude-sonnet-4-6');
